        ...
        <div className="hidden lg:flex w-1/3 justify-center">
          <ul className={`flex space-x-4 ${darkMode ? 'text-white' : 'text-black'}`}>
            ...
            <li>
              <a 
                href="/casestudies" 
                className={`${isActive('/casestudies') ? 'font-bold' : ''} hover:${darkMode ? 'text-gray-300' : 'text-secondary'} transition duration-200`} 
                onClick={handleLinkClick}
              >
                Case Studies
              </a>
            ...
            <li>
              <a 
                href="/blog" 
                className={`${isActive('/blog') ? 'font-bold' : ''} hover:${darkMode ? 'text-gray-300' : 'text-secondary'} transition duration-200`} 
                onClick={handleLinkClick}
              >
                Blog
              </a>
