...
const Stats = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            <h1 className="my-10 text-center text-2xl font-extrabold">Grow your business with paid ads</h1>
            ...
            <div className={`flex flex-wrap w-full justify-center gap-6 p-6 text-primary`}>
