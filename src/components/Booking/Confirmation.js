...
const Confirmation = ({ formData, darkMode }) => {
    const generateGoogleCalendarUrl = () => {
        const { appointmentDate, appointmentTime, first_name, last_name } = formData;
        ...
        return `https://calendar.google.com/calendar/r/eventedit?text=Appointment+with+Zimapeak&dates=${startDate}/${endDate}&details=Appointment+for+${first_name}&location=${formData.email}`;
    };
